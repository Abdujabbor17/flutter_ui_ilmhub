...
class EditContact extends StatefulWidget {
   EditContact(this.index,{Key? key}) : super(key: key);
...
class _EditContactState extends State<EditContact> {
  ...
  @override
  void initState() {
    nameCtr.text = contacts[widget.index].name;
    surNameCtr.text = contacts[widget.index].surname ?? '';
    phoneNumberCtr.text = contacts[widget.index].phoneNumber;
    super.initState();
  }
          ...
          IconButton(
              onPressed: () {
                if (nameCtr.text.isNotEmpty &&
                  ...
                  var editedContact = ContactModel(
                      nameCtr.text, surNameCtr.text,
                      phoneNumberCtr.text);
                  contacts[widget.index] = editedContact;
